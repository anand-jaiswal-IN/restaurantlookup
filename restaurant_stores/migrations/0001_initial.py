    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='food_category/default.png', null=True, upload_to='food_category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.URLField(default='https://www.yourdomain.com', max_length=50)),
                ('description', models.TextField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20)),
                ('image', models.ImageField(blank=True, default='subfood_category/default.png', null=True, upload_to='subfood_category')),
                ('description', models.TextField(blank=True, max_length=255, null=True)),
