...
MIDDLEWARE = [
    ...
    "restaurantlookup.middleware.LoginRequiredMiddleware",
]

ROOT_URLCONF = "restaurantlookup.urls"
...
WSGI_APPLICATION = "restaurantlookup.wsgi.application"
...
EMAIL_USE_SSL = bool(environ.get("EMAIL_USE_SSL"))
